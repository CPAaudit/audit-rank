...
def grade_batch(items, api_key):
    ...
    try:
        ...
        prompt_lines = [
            ...
            "[채점 기준]",
            "1. **키워드 정확성(50%)**: 제시된 [모범 답안]의 용어가 사용자 답안에 '정확하게' 포함되었는지 확인하십시오. 유사한 단어라도 전문 용어가 아니면 감점하십시오.",
            "2. **논리적 구체성(50%)**: 모범 답안의 논리 전개를 정확히 따르는지 평가하십시오. 단순히 문맥만 맞고 구체적인 내용이 없으면 3점 이하로 채점하십시오.",
            "3. **감점 요인**: 핵심 개념 없이 서술만 길게 늘어놓은 경우 대폭 감점하십시오.",
            "",
            "[출력 형식]",
            "마크다운 없이 **순수 JSON 리스트**만 출력하시오.",
            "feedback 필드는 반드시 아래 마크다운 형식을 따라야 합니다:",
            "  - **� 부족한 점**: (구체적인 개선점, 30자 이내)",
            "  - **👍 잘한 점**: (구체적인 칭찬, 30자 이내)",
            "",
